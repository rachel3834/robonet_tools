...
if __name__ == '__main__':
	...
	req_colour_index = argv[5]
        ...
        input_colour = float( raw_input('Please input the star colour: ') )
        colour_error = float( raw_input('Please input the error on the star colour: ') )
	star_class = raw_input('Please input the spectral class [III, IV]: ')
	input_index = raw_input('Input colour index [e.g. V-I]: ')
	req_colour_index = raw_input('Input required colour index: ')
